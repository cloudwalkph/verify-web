<div class="black-description project-location">
    <div class="col-md-4 col-sm-6 col-xs-12">
        ...
        @if(isset($chartData))
            <h4><b>Verified Hits:</b> {{ count(json_decode($chartData)) }} / {{ ($location->manual_hits > 0) ? $location->manual_hits : 'NA' }}  ( {{ ($location->manual_hits > 0) ? round((count(json_decode($chartData))/$location->manual_hits) * 100, 2) : 'NA' }} %) </h4>
        @endif
    </div>
    <div class="col-md-4 col-sm-6 col-xs-12">
